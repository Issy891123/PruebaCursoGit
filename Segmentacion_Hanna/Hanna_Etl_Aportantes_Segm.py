...
headers = ['TIP_IDENTIFICACION', 'NUM_IDENTIFICACION', 'NOM_EMPRESA', 'COD_MUNICIPIO_DANE',
           'DIR_CORRESPONDECIA', 'EST_VINCULACION', 'TIP_APORTANTE', 'TIP_SECTOR', 'ACT_ECONOMICA',
           'SIT_EMPRESA_LEY_1429', 'PRO_PAGO_LEY_1429', 'SIT_EMPRESA_LEY_590', 'PRO_PAGO_LEY_590',
           'APO_TOTAL_MENSUAL', 'INT_PAGADOS_MORA', 'VAL_REINTEGROS'
           ]
...
dfhana = dataframe.create_dataframe_from_pandas(connection_context=cc,
                                                ...
                                                table_name='TBL_APORTANTES_SEGM',
