...
headers = ['INT_APORT', 'TIPO', 'NIF', 'NOMBRE', 'IMPORTE_ML', 'INTERESES', 'CLASE_APORTANTE']


# Leer el archivo xlsx en dataframe de pandas
df = pd.read_excel(path_file, header=None, names=headers, dtype="object", engine='openpyxl', sheet_name="Fosyga", skiprows=[0])
