...
while not terminado:
    try:
        ...
        for ciudad in ciudades:
            if ciudad in ciudades_descargadas: ## Escribir aquí la condición con ciudades descargadas
                pass
            else:
                ...
                while not flag_ciiu:
                    ...
                    if reg_sel <= 50000:
                        ...
                        chrome_driver.find_element(By.XPATH, '//*[@id="ContentPlaceHolder1_Generar_BaseDatos"]').click()  # Procesar BD
                            ...
                            for r in range(len(ciiu) + 2, len(rows) + 2):
                                ...
                                if not flag_ciiu and not Descargar and len(año_matr) == 0:
                                    if r > 23:
                                        ...
                                        print("Procede a descargar con 2 filtros. Ciudad y Ciiu. Línea 279")
                                        archivo_log.write("Procede a descargar con 2 filtros. Ciudad y Ciiu. Línea 279")
                            ...
                            if len(opcion_ciuu) == 1:
                                ...
                                for año in range(1, cant_años_mat):
                                    ...
                                    if reg_sel < 50000 and len(año_matr) < 93 and not Descargar and (contador_ciiu + reg_sel) < val_total_ciiu:
                                        ...
                                        print("Procede a generar base con 3 filtros")
                                        archivo_log.write("Procede a generar base con 3 filtros")
                                ...
                                for opcion in opcion_ciuu:
                                    if opcion_ciuu.index(opcion) == len(opcion_ciuu) - 1:
                                        ...
                                        if len(ciiu) >= 22 or Descargar:
                                            ...
                                            print("Procede a descargar con 2 filtros. Ciudad y Ciiu. Línea 589")
                                            archivo_log.write("Procede a descargar con 2 filtros. Ciudad y Ciiu. Línea 589")
